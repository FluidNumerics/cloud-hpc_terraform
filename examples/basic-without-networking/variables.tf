...
variable "vpc_subnet" {
  type = string
  description = "The VPC subnet self_link for the controller and login nodes. Note that the subnet must be associated with the GCP region that contains the primary_zone"
}
